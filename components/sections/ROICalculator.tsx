    ...
    <section id="roi" className="section-padding bg-gray-100 border-t-4 border-black">
      <div className="container">
        ...
        <div className="border-4 border-black bg-white">
          <div className="grid lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x-4 divide-black">
            <div className="p-4 sm:p-6 lg:p-12">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-black uppercase mb-4 sm:mb-8">YOUR CURRENT SITUATION</h3>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 sm:py-3 text-base sm:text-lg font-mono border-2 border-black focus:outline-none focus:ring-2 focus:ring-black"
                    />
                  </div>
                </div>
            ...
            <div className="bg-black text-white p-4 sm:p-6 lg:p-12">
              ...
              <div className="space-y-4">
                <div className="border-2 border-white p-4">
                  ...
                  <p className="text-3xl sm:text-4xl lg:text-5xl font-black">+${roi.additionalRevenue}</p>
                </div>
                
                <div className="border border-gray-600 p-3">
                  <p className="text-xs font-mono uppercase mb-1">MORE TIME FOR RELATIONSHIPS</p>
                  <p className="text-xl sm:text-2xl lg:text-3xl font-bold">+${roi.revenuePerRep}/REP</p>
                </div>
                ...
                <div className="bg-white text-black p-6 text-center">
                  ...
                  <p className="text-5xl sm:text-6xl lg:text-7xl font-black">{roi.roiMultiple}X</p>
        ...
        <div className="mt-8 sm:mt-12">
          <div className="border-4 border-black bg-white p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg lg:text-xl font-mono uppercase mt-4 mb-4 sm:mb-6">
              ONCE YOU LOSE YOUR CULTURE, YOU CAN&apos;T BUY IT BACK.
            </p>
            
            <div className="border-2 border-black p-4 sm:p-6 mb-4 sm:mb-6">
              <p className="font-black uppercase mb-2 sm:mb-4 text-sm sm:text-base">YOUR CHOICE:</p>
              <div className="grid sm:grid-cols-2 gap-2 sm:gap-4 text-left">
                <div className="border border-black p-3 sm:p-4">
                  <p className="font-bold uppercase text-sm sm:text-base">GENERIC AUTOMATION</p>
                  <p className="text-xs sm:text-sm font-mono uppercase mt-1 sm:mt-2">LOSE WHAT MAKES YOU SPECIAL</p>
                </div>
                <div className="bg-black text-white p-3 sm:p-4">
                  <p className="font-bold uppercase text-sm sm:text-base">CULTURE-FIRST GROWTH</p>
                  <p className="text-xs sm:text-sm font-mono uppercase mt-1 sm:mt-2">BECOME MORE OF WHO YOU ARE</p>
                </div>
              </div>
            </div>
