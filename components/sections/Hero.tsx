      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
          <div className="lg:col-span-8">
            {/* The validation */}
            <div className="mb-8">
              <p className="text-sm font-mono text-gray-600 mb-2">MIDWEST DISTRIBUTOR WHO KEPT THEIR CULTURE:</p>
              <p className="text-6xl lg:text-7xl font-black tracking-tighter">47% Growth</p>
              <p className="text-lg font-medium mt-2">Without losing a single family business value.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#success" className="btn-secondary">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="border-2 border-black bg-white p-6">
              ...
              <div className="mb-6">
                <div className="bg-black text-white p-3 mb-3">
                  <h5 className="font-bold text-sm">WHAT THEY&apos;RE TELLING YOU:</h5>
                </div>
              ...
              <div className="mb-6">
                <div className="border-2 border-black p-3 mb-3">
                  <h5 className="font-bold text-sm">WHAT WE KNOW:</h5>
                </div>
                <ul className="space-y-1 text-sm font-mono pl-4">
            ...
            <div className="mt-8 border border-black p-4">
              ...
              <p className="text-xs font-mono uppercase mt-1">ONCE YOU AUTOMATE AWAY YOUR CULTURE, YOU CAN&apos;T GET IT BACK</p>
            </div>
          </div>
        </div>
      </div>
