export default function BoringPhilosophy() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="border-4 border-white p-8">
            <h3 className="font-black uppercase text-xl mb-6">WHY BORING WINS</h3>
            
            <div className="space-y-6">
              <div>
                <h4 className="font-black uppercase mb-2">BORING IS PREDICTABLE</h4>
                <p className="font-mono text-sm">
                  Your team can plan around it. Your customers can count on it. 
                  Your family can trust it. No surprises, just results.
                </p>
              </div>
              ...
              <div>
                <h4 className="font-black uppercase mb-2">BORING IS SUSTAINABLE</h4>
                <p className="font-mono text-sm">
                  No burnout. No culture shock. No mass exodus. Just steady improvement 
                  that everyone can embrace.
                </p>
              </div>
              
              <div>
                <h4 className="font-black uppercase mb-2">BORING IS PROFITABLE</h4>
                <p className="font-mono text-sm">
                  Steady 40% growth beats hockey sticks that break. Predictable revenue 
                  beats unicorn dreams.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-4 border-white p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-red-900 p-4">
                <h4 className="font-black uppercase mb-2">BROKEN SYSTEMS</h4>
                <p className="font-mono text-sm">
                  Revolutionary changes that nobody actually uses
                </p>
              </div>
        ...
        <div className="bg-gray-900 p-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div>
              ...
              <p className="font-mono text-sm">
                Of boring improvements compound
              </p>
            </div>
            <div>
              <p className="text-4xl font-black mb-2">0</p>
              <p className="font-mono text-sm">
                Boring companies that went bankrupt
              </p>
            </div>
          </div>
        </div>
